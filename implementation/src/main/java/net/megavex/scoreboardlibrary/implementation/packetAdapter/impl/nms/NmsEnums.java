...
public final class NmsEnums {
  ...
  static {
    if (TEAM_COLLISION_RULE_CLASS != null) {
      ...
      COLLISION_RULE_PUSH_OTHER_TEAMS = ReflectUtil.getEnumInstance(TEAM_COLLISION_RULE_CLASS, "PUSH_OTHER_TEAMS", "HIDE_FOR_OTHER_TEAMS");
      COLLISION_RULE_PUSH_OWN_TEAM = ReflectUtil.getEnumInstance(TEAM_COLLISION_RULE_CLASS, "PUSH_OWN_TEAM", "HIDE_FOR_OWN_TEAM");
    } else {
